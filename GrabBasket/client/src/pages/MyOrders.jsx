...
const MyOrders = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-end w-max mb-8' >
      ...
      <div className='w-16 h-0.5 bg-[##377DFF] rounded-full'></div>
    </div>
        ...
        <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl'>
            ...
            {order.items.map((item,index)=>(
              ...
              <div className='flex items-center mb-4 md:mb-0'>
                ...
                <div className='ml-4'><h2 className='text-xl font-medium text-gray-800'>{item.product.name}</h2>
              ...
              <p className='text-[#377DFF] text-lg font-medium'> Amount : {currency}{item.product.offerPrice*item.quantity}</p>
              </div>
